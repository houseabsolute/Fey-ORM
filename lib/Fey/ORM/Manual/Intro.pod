...
To define your schema class you'll use L<Fey::Schema::Class>:
...
attribute!). This method returns a L<Fey::Object::Iterator> which
...
returns a L<Fey::Object::Iterator::Caching> object. Subsequent calls
...
L<Fey::Meta::Attribute::FromSelect>, which manages the details of
executing the query and sticking the value in an attribute. You just
provide a L<Fey::SQL::Select> object and an optional subroutine
